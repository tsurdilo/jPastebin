...
public class PastebinAccount {
     ...
     */
    public PastebinAccount(String developerKey,
                           String username,
                           String password) {
    ...
    public void login() throws LoginException {
        ...
        post.put("api_dev_key",
                 getDeveloperKey());
        post.put("api_user_name",
                 username);
        post.put("api_user_password",
                 password);

        String response = Web.getContents(Pastebin.API_LOGIN_LINK,
                                          post);
    ...
    public PastebinLink[] getPastes(int limit) throws ParseException {
        ...
        post.put("api_user_key",
                 getUserSessionId());
        post.put("api_results_limit",
                 Integer.toString(limit));
        post.put("api_option",
                 "list");

        String response = Web.getContents(Pastebin.API_POST_LINK,
                                          post);
