...
public class PastebinLink extends AbstractPasteLink {
     ...
     */
    public PastebinLink(PastebinPaste paste,
                        URL url) {
        this(paste,
             url,
     ...
     */
    public void delete(String developerKey,
                       PastebinAccount account) throws PasteException {
    ...
    public void delete() throws PasteException {
        delete(getPaste().getDeveloperKey(),
               getPaste().getAccount());
    }
